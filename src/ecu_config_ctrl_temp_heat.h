...
#define CTRL_TEMP_HEAT_REC (200 * TIME_uSEC)
#define CTRL_TEMP_HEAT_OFFSET (3.0 * TIME_SEC)

#define DD_HEATER_REC (200 * TIME_uSEC)
...
#define CTRL_TEMP_HEAT_OP_D_TIME (1.0 * TIME_SEC / DD_HEATER_REC)
#define CTRL_TEMP_HEAT_HISTERESIS (0.5)
#define CTRL_TEMP_HEAT_CUR_DEFAULT (10.0)
#define CTRL_TEMP_HEAT_SP_DEFAULT (19.0)
