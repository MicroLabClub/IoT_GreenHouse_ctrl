...
void ctrl_press_isol_mqtt_publish();
...
{
#ifdef USE_CTRL_TEMP_VENT
  int temp_ctrl_cur_temp = ctrl_temp_vent_get_current_temp();
  int temp_ctrl_sp = ctrl_temp_vent_get_setpoint();
...
{
#ifdef USE_CTRL_TEMP_HEAT
  int temp_ctrl_cur_temp = ctrl_temp_heat_get_current_temp();
  int temp_ctrl_sp = ctrl_temp_heat_get_setpoint();
...
{
#ifdef USE_CTRL_AIR_HUM
  int air_hum_ctrl_cur_hum = ctrl_air_hum_get_current_hum();
  int air_hum_ctrl_sp = ctrl_air_hum_get_setpoint();
...
{
#ifdef USE_CTRL_SOIL_MOIST
  int soil_moist_ctrl_cur_moist = ctrl_soil_moist_get_current_moist();
  int soil_moist_ctrl_sp = ctrl_soil_moist_get_setpoint();
...
{
#ifdef USE_CTRL_LIGHTS
  int light_ctrl_cur_lum = ctrl_lights_get_current_light();
  int light_ctrl_sp = ctrl_lights_get_setpoint();
