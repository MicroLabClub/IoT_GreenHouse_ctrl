...
#include "srv_ctrl_lights/srv_ctrl_lights.h"
...
#define SRV_CTRL_LIGHTS_REC 10000 / SYS_TICK
int srv_ctrl_lights_rec_cnt = SRV_CTRL_LIGHTS_REC + 6;
...
void os_seq_scheduler()
{
  ...
  // Task de control al temperaturii ON-OFF cu Heater
  if (--srv_ctrl_lights_rec_cnt <= 0)
  {
    srv_ctrl_lights_loop();
    srv_ctrl_lights_rec_cnt = SRV_CTRL_LIGHTS_REC;
  }
