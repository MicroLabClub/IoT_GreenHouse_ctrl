...
#ifndef CTRL_TEMP_HEAT_SP_DEFAULT
#define CTRL_TEMP_HEAT_SP_DEFAULT (19.0)
#endif

#ifndef CTRL_TEMP_HEAT_HISTERESIS
#define CTRL_TEMP_HEAT_HISTERESIS (0.5)
#endif

#ifndef CTRL_TEMP_HEAT_OP_D_TIME
#define CTRL_TEMP_HEAT_OP_D_TIME 10
#endif

#define CTRL_TEMP_HEAT_OUT_OFF 0
#define CTRL_TEMP_HEAT_OUT_ON 1
